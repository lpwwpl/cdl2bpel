...
public class SimpleDocumentProvider extends AbstractDocumentProvider {
	 ...
	 * <code>IPathEditorInput</code>. If the file does not exist,
	 * <code>true</code> is returned.
	 * 
	 * @param document
	 *            the document to fill with the contents of <code>input</code>
	 * @param input
	 *            the editor input
	...
	private void setDocumentContent(IDocument document, Reader reader)
		...
		try {
			...
			doc = document;
			System.out.println("SetDocumentContent");
		} finally {
			in.close();
		}
	}
