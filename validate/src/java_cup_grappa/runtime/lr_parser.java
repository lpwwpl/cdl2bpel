...
public abstract class lr_parser {
	 ...
	 * 
	 * @param act_num
	 *            the internal index of the action to be performed.
	 * @param parser
	 *            the parser object we are acting for.
	 * @param stack
	 *            the parse stack of that object.
	 * @param top
	...
	public void report_error(String message, Object info) {
		...
		if (info instanceof Symbol) {
			if (((Symbol) info).left != -1) {
				message += " at character " + ((Symbol) info).left
						+ " of input";
			}
		}
		Message.add(s, Message.DEBUG);
	}
	...
	public void debug_message(String mess) {
		Message.add(mess, Message.DEBUG);
	}
		...
		for (;;) {
			...
			if (act > 0) {
				...
				if (debug) {
					...
					/*
					 * advance simulated input, if we run off the end, we are
					 * done
					 */
				}
