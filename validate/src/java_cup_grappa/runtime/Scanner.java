package java_cup_grappa.runtime;
...
/*
 * Interface Scanner Declares the next_token() method that should be implemented
 * by scanners. This method is typically called by lr_parser.scan().
 */
