...
public abstract class BPELActivity implements BPELVisitable {
	...
	/**
	 * Create a new BPEL activity from the given element.
	 * 
	 * @param element
	...
	public BPELActivity(Element element) {
		...
		this.setPartnerLink(partnerLink);
	}
	...
	/**
	 * 
	 * @return String A Partner Link for the activity
	 */
	public String getPartnerLink() {
		String name = element.getAttribute("partnerLink");
		return name;
	}
