...
import edu.xjtu.cdl2bpel.utils.Dot;

/*
 * February 20, 2009, Dang Trung Anh
 ...
 * Code rating
 * 
 * DotFileAttributeWriter 20081122, hverbeek: Red (working on writeToDot)
 */
...
public class ModelGraph extends Graph implements DotFileWriter,
	...
	/*
	 * March 13, 2009, Dang Trung Anh add dummy vertices and dummy edges. These
	 * vertices and edges are only used when writing to Dot.
	 */
	private ArrayList<ModelGraphVertex> dummyVertices;
	private ArrayList<ModelGraphEdge> dummyEdges;

	/*
	 * March 13, 2009, Dang Trung Anh Added attributes used when writing to Dot.
	 */
	...
	/*
	 * March 13, 2009, Dang Trung Anh added weightedArcs attribute. If set,
	...
	/**
	 * March 13, 2009, Dang Trung Anh sets whether multiple arcs should be
	 * allowed or not.
	 * 
	 * @param w
	...
	/**
	 * March 13, 2009, Dang Trung Anh gets whether multiple arcs should be
	 * allowed or not.
	 * 
	...
	/**
	 * March 13, 2009, Dang Trung Anh OK for multiple arcs.
	 * 
	...
	/**
	 * March 13, 2009, Dang Trung Anh Renamed from hasEdge to getFirstEdge
	 * 
