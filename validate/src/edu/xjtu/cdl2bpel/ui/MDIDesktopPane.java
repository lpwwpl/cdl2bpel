...
public class MDIDesktopPane extends JDesktopPane {
	...
	public MDIDesktopPane() {
		...
		if (bgPath.equals("NONE") == false) {
			bgTileImage = ((new ImageIcon(bgPath))).getImage();
		}
	...
	protected void paintComponent(Graphics g) {
		if (bgTileImage == null) {
			...
			g.drawImage(buffer, clip.x, clip.y, clip.x + clip.width, clip.y
					+ clip.height, clip.x, clip.y, clip.x + clip.width, clip.y
					+ clip.height, null);
		}
	}
