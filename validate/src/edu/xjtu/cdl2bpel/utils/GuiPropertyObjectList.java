...
/**
 * An object list property that can be readily displayed as it maintains its own
 ...
 * values.add("Anne");
 * values.add("Maria");
 * GuiPropertyObjectList names = new GuiPropertyObjectList("Names", values); <br>
 ...
 */
public class GuiPropertyObjectList implements ListSelectionListener {

	// property attributes
	private String myName;
	private String myDescription;
	private List myAvailableValues;
	private GUIPropertyListEnumeration myAvailableList;
	 ...
	 */
	public GuiPropertyObjectList(String name, List initialValues,
	 ...
	 *            Furthermore they should contain the initial values
	 */
	public GuiPropertyObjectList(String name, String description,
	...
	public GuiPropertyObjectList(String name, String description,
		...
		// GUI attributes
		myAvailableValues = new ArrayList();
	...
	/*
	 * Helper mehtod to redraw property panel as soon as list of selected values
	 * has changed.
	 */
