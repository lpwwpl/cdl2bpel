 ...
 * CDL2BPEL_XJTU
 *
 * $Id: SendEndImpl.java,v 1.1 2011/02/21 06:24:06 administrator Exp $
 */
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Send End</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link edu.xjtu.cdl2bpel.orchestra.impl.SendEndImpl#getIsCreatedByPassedChannel <em>Is Created By Passed Channel</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SendEndImpl extends CommunicationImpl implements SendEnd {
	/**
	...
	protected EClass eStaticClass() {
		return OrchestraPackage.Literals.SEND_END;
	}
	...
	public void setIsCreatedByPassedChannel(Boolean newIsCreatedByPassedChannel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OrchestraPackage.SEND_END__IS_CREATED_BY_PASSED_CHANNEL, oldIsCreatedByPassedChannel, isCreatedByPassedChannel));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OrchestraPackage.SEND_END__IS_CREATED_BY_PASSED_CHANNEL:
