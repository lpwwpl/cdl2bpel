 ...
 * CDL2BPEL_XJTU
 *
 * $Id: AsynCallBackImpl.java,v 1.1 2011/02/21 06:24:06 administrator Exp $
 */
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Asyn Call Back</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link edu.xjtu.cdl2bpel.orchestra.impl.AsynCallBackImpl#getIsCreatedByPassedChannel <em>Is Created By Passed Channel</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AsynCallBackImpl extends CommunicationImpl implements AsynCallBack {
	/**
	...
	protected EClass eStaticClass() {
		return OrchestraPackage.Literals.ASYN_CALL_BACK;
	}
	...
	public void setIsCreatedByPassedChannel(Boolean newIsCreatedByPassedChannel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OrchestraPackage.ASYN_CALL_BACK__IS_CREATED_BY_PASSED_CHANNEL, oldIsCreatedByPassedChannel, isCreatedByPassedChannel));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OrchestraPackage.ASYN_CALL_BACK__IS_CREATED_BY_PASSED_CHANNEL:
