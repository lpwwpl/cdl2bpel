...
//		GlobalArchitecture artitecture = CDL2Orchestra.generate(cdlpack,
//				roleTypes);
//		// GlobalArchitectureImpl globalArchitectureImpl=new
//		// GlobalArchitectureImpl();//需要把GlobalArchitectureImpl的构造方法改为protected类型的
